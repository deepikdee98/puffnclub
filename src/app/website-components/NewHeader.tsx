    ...
    >
        ...
        <div className="container">
          ...
          >
            ...
            <div className="d-flex align-items-center gap-4">
              <Link href="/" className="text-dark text-decoration-none fs-6">
                Home
              </Link>
              <Link
                href="/products"
          ...
          {/* Mobile Header */}
          <div
            className={`d-flex d-lg-none justify-content-between align-items-center ${styles.mobileHeader}`}
          >
            {/* Left: Hamburger Menu */}
            <button
              className="btn btn-link text-dark p-0 border-0"
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <Link href="/profile" className="text-dark" title="Profile">
                <Image
                  src="/images/profile-icon.svg"
                  alt="Profile"
                  width={20}
      ...
      <div
        className={`${styles.offcanvas} ${
          mobileMenuOpen ? styles.offcanvasOpen : ""
        }`}
      >
